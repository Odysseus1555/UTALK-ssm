...
body {transform: scale(0.75) translate(0px, 0px); }
 
</style>
</head>
    <body style="background-color:pink;">
        <h1><p style="text-align:center;color:purple">I Love JAVA!</p></h1>
        <h1><p style="text-align:center;color:purple">I Love haha!</p></h1>                     <canvas id="c"></canvas>
        <script>
		var b = document.body;
